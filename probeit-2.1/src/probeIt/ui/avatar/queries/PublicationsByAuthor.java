 ...
 * @author paulo
 */
public class PublicationsByAuthor {

	private edu.utep.trust.provenance.RDFStore proxy;
	
	public PublicationsByAuthor() {
    ...
    public String doQuery(String authorURI) {
    	String query = 
    		...
    		"?NodeSet pmlj:isConsequentOf ?InferenceStep . " +
    		"?InferenceStep pmlj:hasSourceUsage ?SourceUsage . " +
    		"?SourceUsage pmlp:hasSource <" + authorURI + "> ." +
    		"}";
